...
const PlusFour = (tableId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        (0, logger_1.Logger)("PlusFour", JSON.stringify({ tableId }));
        ...
        ;
        let pickCards = [], penaltySeatIndex = -1, forLimit = (TableDetails.numberOfCardToPick + 4);
        ...
        (0, logger_1.Logger)('PlusFour Error : ', error);
    }
    ;
});
exports.PlusFour = PlusFour;
