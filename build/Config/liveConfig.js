...
exports.LiveConfig = void 0;
require("dotenv/config");
const LiveConfig = () => {
    const { ENVIRONMENT, REDIS_HOST, REDIS_PORT, REDIS_PASSWORD, REDIS_DATABASE_NUMBER, PUBSUB_REDIS_HOST, PUBSUB_REDIS_PORT, PUBSUB_REDIS_PASSWORD, PUBSUB_REDIS_DATABASE_NUMBER, SERVER_PORT, SERVER_CERT_PATH, SERVER_KEY_PATH, } = process.env;
    const Redis = {
        // ! Redis
