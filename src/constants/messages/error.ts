export = Object.freeze({
  ...
  WILD_CARD_NOT_PICK : `Wild Cards Can Not Pick`,
  ...
  LOCK_IN_PEROID_MSG : `PLAYERS ON THIS TABLE HAVE BEEN LOCKED. NOTE: ENTRY FEE WILL BE DEDUCTED IF YOU LEAVE THE TABLE NOW.`,
