import { EVENTS, NUMERICAL, CARDS_STATUS } from "../constants";
import { isPure, isImpure, isSet, arraySum, sortCard } from "./cardLogic";
...
async function manageAndUpdateData(
    currentCard: Array<Array<string>> | any,
    ...
    let newGroupCardsArr: any =  null; //(typeof isGroupMakes == "boolean") ? currentCard : isGroupMakes;
