...
function getEnvJSON() {
  ...
  const GAME_DETAILS= `GAME_DETAILS`;
  const LOBBY_LIST_DETAIL = `LOBBY_LIST_DETAIL`;
  ...
  return Object.freeze({
    ...
    GAME_DETAILS : `${processEnv[API_BASE_URL]}/mgpApp/game/getSingleGameDetails`,
    LOBBY_LIST_DETAIL :`${processEnv[API_BASE_URL]}/mgpApp/headToHead/getTournaments`,
